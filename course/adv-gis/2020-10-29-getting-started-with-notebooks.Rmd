...
Well, it turns out the interface using something called *Python*.
...
From there, we can host layers onto ArcGIS Online and add the layers to a web map for visualizing.
