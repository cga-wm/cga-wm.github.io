...
1. [Python Fundamentals][nb1]
    ...
    A first look at (or refresher on) the Python syntax.
1. [More Python Fundamentals][nb2]

    A second look at fundamental Python concepts.
...
1. [The File Geodatabase][nb5]
    ...
    Tutorial on how to create your own file geodatabase for organizing your geoprocess inputs and outputs or field collection features.
