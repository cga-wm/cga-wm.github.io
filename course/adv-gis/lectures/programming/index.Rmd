...
**Programming...** <span class="fragment">**huh!**</span><br />
<span class="fragment">**What is good for?**</span><br />
<span class="fragment">**Absolutely...**</span>
<span class="fragment">**Something?**</span>
...
- Why is distance important in GIS?
</aside>
...
- The idea that computer programs are a language means we need to get two things straight: *semantics* and *syntax*
    * Does anyone know what either of these words mean?
</aside>
...
| My computer's home directory is ... | `>>> import os`<br />`>>> print(os.path.expanduser("~"))`<br />`C:\Users\twdavis17` |
