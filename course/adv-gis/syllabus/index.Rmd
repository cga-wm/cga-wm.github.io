...
:   - Instant messaging using [GroupMe](https://groupme.com/)
    ...
    - ArcGIS Notebooks and item sharing on [ArcGIS Online](https://www.arcgis.com/index.html)
        - _Please be sure to log into [arcgis.com](https://www.arcgis.com/index.html) using the W&M organization URL: **cga-wm**.maps.arcgis.com (see [here](https://youtu.be/x07Xyoe0d2k) for instructions)_
...
1. Final evaluation.
    - Successfully complete two (2) special works projects: one written in the performance accomplishments document and one demonstrated live during the final evaluation.
...
* Any section of the course evaluation (i.e., sections A--D) with more evaluations in the "Does Not Meet" category than in the "Fully Meets" and "Exceeds" categories combined will be considered "Unsatisfactory" for that section.
* The instructor reserves the right to adjust a student's final evaluation score by at most one-half step (e.g., in a plus/minus scale, a C may be rewarded to a C+ or downgraded to a C--) so long as it does not conflict with the following rules.
    * A student cannot receive a final grade higher than Fully Meets Expectations (B) if one or more of their individual accomplishments receives an Unsatisfactory evaluation score.
