...
:   Not just a good reminder, but a weekly newsletter of useful/curious datasets published by Jeremy Singer-Vine.
    The archive provides access to historical editions of the newsletter, each with links that point out to a variety of datasets.
...
[Global Forest Change](https://storage.googleapis.com/earthenginepartners-hansen/GFC-2020-v1.8/download.html)
...
:   Committed to providing the highest-quality data on the world's forests.
    _Includes links to the Hansen datasets._
...
:   A free data repository open to all researchers from any discipline where you can share, archive, cite, access, and explore research data.
...
:   A time-stamped semi-geolocated incident log of global shark attacks. See also [Sharks.org](https://www.sharks.org/global-shark-attack-file) for a hosted Google sheet version of the global shark attack file (_notice that their archive may not be up-to-date_).
